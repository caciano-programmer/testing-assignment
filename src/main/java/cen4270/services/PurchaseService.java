...
public class PurchaseService {
    ...
    private BankInterface bankClient;
    private InventoryInterface inventoryClient;
    private NotificationInterface notificationClient;

    public PurchaseService(AccountService accountService, BankInterface bankClient, InventoryInterface inventoryClient, NotificationInterface notificationClient) {
    ...
    public void purchaseItem(String userEmail, String itemId, int quantity) throws PurchaseException, ChargeCreditCardException, SendEmailException {
        UserInterface user = accountService.getRegisteredUser(userEmail);
    ...
    public int calculatePrice(UserInterface user, Item item) throws PurchaseException {
